      ...
      {!submitted ? (
        <div className="text-5xl ">
          ...
          <div className="text-xl">
            Fill out your information and a Fandrum+ representative will contact
            you shortly.
          </div>
        </div>
      ) : (
              ...
              render={({ field }) => (
                <FormItem className="flex items-center justify-center  space-y-4 w-full">
                  ...
                  >
                    ...
                    <SelectContent>
                      <div className="flex gap-4">
                        <SelectItem value="1-10">1-10k</SelectItem>
                      </div>
                      <SelectItem value="11-50">11-50k</SelectItem>
                      <SelectItem value="51-200">51-200k</SelectItem>
                      <SelectItem value="201-500">201-500k</SelectItem>
                      <SelectItem value="501-1000">501-1000k</SelectItem>
                      <SelectItem value="1000+">1000k+</SelectItem>
                    </SelectContent>
                  </Select>
