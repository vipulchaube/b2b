  ...
  return (
    ...
    >
      <div className="container mx-auto text-center md:w-1/2">
        ...
        "
        >
          The best platform for deep-diving into content.
        </div>
        ...
        "
        >
          Want more from your content? Fandrum+ is easy for organisations of all
          sizes to use, so you can deliver quality content, reach out to the
          fans and maximize the returns.
        </p>
